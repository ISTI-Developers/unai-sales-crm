...
import TableConfigurations from "../components/reports/config.report";
import SelectedFilters from "../components/reports/filters.report";
                  ...
                  {headerGroup.headers.map((header, index) => {
                    ...
                    return (
                      <TableHead
                        key={header.id}
                        className={cn(
                          "bg-main-400 text-white shadow text-[0.65rem] uppercase font-bold w-fit text-center",
                          index === 0 ? "sticky" : ""
                        )}
