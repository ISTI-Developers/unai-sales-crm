        ...
        <section id="client-activities">
          <Tabs value={tab} onValueChange={setTab}>
            ...
            <TabsContent value="logs">
              <ClientHistory modules={["clients", "client_contact", ...client.mediums.map(() => "client_mediums"), ...client.account_executives.map(() => "client_accounts")]} clientIDs={[client.client_id, client.contact_id, ...client.mediums.map(med => med.cm_id), ...client.account_executives.map(ae => ae.client_account_id)]} />
            </TabsContent>
          </Tabs>
        </section>
      </div>
